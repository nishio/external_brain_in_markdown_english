---
title: "Toward Effective Information Sharing and Tacit Knowledge to Language"
---
...
<img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/>
    - Toward [[Efficient information sharing]] and [Verbalization of tacit knowledge

- [[information sharing]] <img src='https://scrapbox.io/api/pages/nishio-en/nishio/icon' alt='nishio.icon' height="19.5"/>

<img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/>
    - [[The person being questioned leaves a note.]] This will increase efficiency, and the difficulty of [[verbalizing]] [[tacit knowledge (knowledge management terminology)]] and the importance of documentation will be taken into account. The language model is expected to facilitate the expansion of documents from query analysis, while taking into account the difficulty of [[verbalizing]] [[tacit knowledge (knowledge management terminology)]] and the importance of documents.

query$\simeq$ 質問<img src='https://scrapbox.io/api/pages/nishio-en/nishio/icon' alt='nishio.icon' height="19.5"/>

<img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/><img src='https://scrapbox.io/api/pages/nishio-en/GPT-4/icon' alt='GPT-4.icon' height="19.5"/>
...
- [/villagepump/the person being questioned leaves a note](https://scrapbox.io/villagepump/the person being questioned leaves a note):.
...
- [/yuta25/You should ask people the same thing over and over again](https://scrapbox.io/yuta25/You should ask people the same thing over and over again).
...
- [/mrsekut-p/the person asked leaves a note](https://scrapbox.io/mrsekut-p/the person asked leaves a note).
...
- [/sta/ tacit knowledge is hard to be aware of](https://scrapbox.io/sta/ tacit knowledge is hard to be aware of).
...
> [0xtkgshn](https://twitter.com/0xtkgshn/status/1639645632314097665) [/mrsekut-p/the person asked leaves note](https://scrapbox.io/mrsekut-p/the person asked leaves note)

> [0xtkgshn](https://twitter.com/0xtkgshn/status/1639645736378990592) [/sta/ tacit knowledge is hard to be aware of](https://scrapbox.io/sta/ tacit knowledge is hard to be aware of)
...
---
This page is auto-translated from [/nishio/効率的な情報共有と暗黙知の言語化に向けて](https://scrapbox.io/nishio/効率的な情報共有と暗黙知の言語化に向けて) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.