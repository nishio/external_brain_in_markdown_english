---
title: "Train travel is a forced time box"
---

I had to go somewhere for the first time in several months, so I took the train.
During the train ride, I did a task that I could do with books and my phone, and I made great progress. It's the effect of [[time-box]].
...
- It can perform the chopped-down tasks, but it doesn't seem to be as effective at focusing as a train.

---
This page is auto-translated from [/nishio/電車移動は強制タイムボックス](https://scrapbox.io/nishio/電車移動は強制タイムボックス) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.