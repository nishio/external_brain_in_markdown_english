...
```
<body>
*1420557134* Lecture on how to come up with ideas
I am reprinting an article I wrote last year when we talked about having an ideaathon in Cybozu about how to come up with ideas. There is no particular information that should be kept confidential. I think it is useful not only within Cybozu.

** Does the idea have to be novel?

You asked if an idea does not have to be new, and I say yes. There are two reasons.

The first is "usefulness over novelty. We are a for-profit company, not a research institute, so it is more important that the idea be useful to Cybozu and its customers than that it be a new idea.
...
** Lecture on how to generate ideas #1
...
** Lecture on how to generate ideas #2
...
- That's the problem with ____, isn't it?"
The response would be.

It is a matter of course, nothing to be surprised or afraid of.

** Lecture on how to generate ideas #3
...
** Lecture on how to generate ideas #4

When we adopted the "the problem is the gap between ideals and reality" framework, which is also used in Cybozu's in-house training, at this year's Kyoto University Summer School, the speed at which ideas were generated increased by about 1.5 times.

Specifically, this is how it was used:

- Exercise "Write down anything that might help improve the problem" 2 minutes
- Explaining the gap between the ideal and the reality is the problem.
...
** Lecture on how to generate ideas #5
...
'Well, thank you for pointing that out. Is there any other way?"
...
** Lecture on how to generate ideas #6
...
** Lecture on how to generate ideas #7
...
[Hatena Diary 2015-01-07](https://nishiohirokazu.hatenadiary.org/archive/2015/01/07)
---
This page is auto-translated from [/nishio/Hatena2015-01-07](https://scrapbox.io/nishio/Hatena2015-01-07) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.