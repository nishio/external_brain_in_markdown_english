...
-2: In windows: C:\Documents and Settings\UserName\Application Data\BSW, in Mac: add "ja" to "languages.txt" in "dominion" in the "localization" file near the app. Then start the application (on Windows, is it generated when the application is launched for the first time?)
...
-5: Find people with /ghook username
...
---
This page is auto-translated from [/nishio/Hatena2010-02-11](https://scrapbox.io/nishio/Hatena2010-02-11) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.