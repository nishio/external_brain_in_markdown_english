...
- If one of them is the one that you think you should do, discard that one. If it's really better to do it and you want to do it, you're already doing it.
    - PS: Another explanation for clarity: "If you think you should do one of the two options and you are not doing it, then you don't want to do that option quite as much as you do the other option. Better to do the option you want to do."

Could merge into #2017 Motivation System Renewal

---
This page is auto-translated from [/nishio/迷った時](https://scrapbox.io/nishio/迷った時) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.