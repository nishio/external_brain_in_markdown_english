...
In other words, it can be said that the need for attention is different in that the need for attention focuses on "being seen" itself, while the need for approval seeks to confirm [[self-worth]] by "being recognized.
...
<img src='https://scrapbox.io/api/pages/nishio-en/o3-mini-high/icon' alt='o3-mini-high.icon' height="19.5"/>In exchange analysis, "[[stroke]]" refers to the act of having one's presence acknowledged by others, and can be divided into positive strokes ([[positive strokes]]) and negative strokes ([[negative strokes]]). When positive strokes are not sufficient, people tend to accept strokes, even negative ones, in order to satisfy their own [[need for existence recognition]], resulting in a tendency to collect negative strokes.
