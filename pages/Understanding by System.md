...
- What is action?
    - For the system
    - For the [[knowledge generation system]], the action is to pass on the generated knowledge to others and see their reactions.
- About this "person
- Should not be unspecified.
- There are many cases of people going crazy for high praise from an unspecified number of people.
        - [[Syrah]] 　 [[Pleasing the masses is evil.]]
...
---
This page is auto-translated from [/nishio/システムによる理解](https://scrapbox.io/nishio/システムによる理解) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.