...
```
<body>
*1295463614*Diary of Pomodoro Day 2
Sequel to <a href='http://d.hatena.ne.jp/nishiohirokazu/20110117/1295282954'>I've started a pomodoro</a>, reprinting what I wrote on Twitter.
>>
Today I only accomplished 2 pomodoros because I was distracted by long build times and external interruptions that should not be ignored. But somehow I feel a sense of accomplishment because I started another project that I had been putting off in the limp state I was in after fighting with something that didn't work, and I must have achieved a rather good result. A sense of accomplishment is important.
<<

>>
Another Pomodoro would have completed the latter project, but I was hungry, so I decided to turn it over to tomorrow. Tomorrow I'll do the harder project, and when I'm tired, I'll do the latter and feel a sense of accomplishment after completing it. Tomatoes are delicious.
<<

The former project is a bit more difficult because I can't read the path to the goal or how long it will take. The latter project is easier mentally because I expect it to be finished in two pomodoros and it looks like it will actually be finished.

<hr>

Day 3 Diary.

I don't know how many I've done! I did about 5 for work and 4 otherwise. The reason I don't know why is because in some cases, after the Pomodoro was over, I went from "let's try a few things" to getting into the groove and working for quite some time. The work itself went very well, which is fine, but from a Pomodoro Technique perspective, I guess I shouldn't count it because I failed to collect the data.

*1295463867* Leverage memo: unreasonable as expected
<a href="http://www.amazon.co.jp/gp/product/4152091665?ie=UTF8&tag=nishiohirokaz-22&linkCode=as2&camp=247&creative=7399& CreativeASIN=4152091665">Leverage Memo for Predictably Irrational [Expanded Edition]</a>. A good book that explains the results of social behavior research in easy-to-understand language while giving papers as references.

(Regarding leveraged notes: If it is a strict excerpt, write it in such a way that it is clear that it is a quote. Otherwise, do not distinguish whether the text is your own summary of what is written in the book or your own thoughts inspired by it. At the point of summarizing, there is subjectivity in what is taken out and what is selected).
...
<iframe src="http://rcm-jp.amazon.co.jp/e/cm?lt1=_blank&bc1=000000&IS2=1&bg1=AAFFAA&fc1=000000&lc1=0000FF&t=nishiohirokaz-22&o=9&p=8&l=as1&m=amazon&f=ifr&md=1X69VDGQCMF7Z30FM082&asins=4152089792" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe><iframe src="http://rcm-jp.amazon.co.jp/e/cm?lt1=_blank&bc1=000000&IS2=1&bg1=AAFFAA&fc1=000000&lc1=0000FF&t=nishiohirokaz-22&o=9&p=8&l=as1&m=amazon&f=ifr&md=1X69VDGQCMF7Z30FM082&asins=4152091665" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
I read the non-expanded edition, but I linked to the newer one since it doesn't seem to be in stock.
</body>
```


[Hatena Diary 2011-01-19](https://nishiohirokazu.hatenadiary.org/archive/2011/01/19)
---
This page is auto-translated from [/nishio/Hatena2011-01-19](https://scrapbox.io/nishio/Hatena2011-01-19) using DeepL. If you looks something interesting but the auto-translated English is not good enough to understand it, feel free to let me know at [@nishio_en](https://twitter.com/nishio_en). I'm very happy to spread my thought to non-Japanese readers.